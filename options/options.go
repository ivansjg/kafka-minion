...
type Options struct {
	...
	// ConsumerGroupWhiteListRegExp - Expose only metrics from consumer groups that match given regular expression
	ConsumerGroupWhiteListRegExp string `envconfig:"CONSUMER_GROUP_WHITE_LIST_REGEXP" default:".*"`
